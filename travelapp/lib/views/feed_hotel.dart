            ...
            body: SizedBox(
              ...
              child: Stack(
                children: [
                  Image.network(
                    locationData
                        .locationData.value.hotel![_currentIndex].fotoUrl!,
                    height: 500,
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.cover,
                    errorBuilder: (context, error, stackTrace) {
                      return Image.asset(
                        "assets/hoteltemp.jpg",
                        fit: BoxFit.cover,
                        height: 500,
                        width: MediaQuery.of(context).size.width,
                      );
                  ...
                  Container(
                      ...
                      child: CarouselSlider(
                        ...
                        items:
                            locationData.locationData.value.hotel!.map((move) {
                          return Builder(
